...
struct blocks_ {
   unsigned block_size; //tamanho de cada bloco
   unsigned num_blocks; //quantos blocos existem
   char blocks[0]; //os dados em si - array sem tamanho fixo, o real tamanho acontece quando quando a memoria é alocada
};
